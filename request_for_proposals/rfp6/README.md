...
- Add a Speech-to-Text agent to the stream, transcribing voice audio before passing it on to the existing [NLP framework (A8)](https://www.notion.so/NLP-Use-Case-Wiki-A8-1f9d800083d68075bdf4d1150d70ebda?pvs=21)
...
- Leverage the existing [Query Tool](https://github.com/cere-io/NLPDevdemo/) to extract results of the [NLP processing (A8)](https://www.notion.so/NLP-Use-Case-Wiki-A8-1f9d800083d68075bdf4d1150d70ebda?pvs=21), which stores outputs in a Cubbie
...
- Audio is transcribed and processed by the [NLP framework (A8)](https://www.notion.so/NLP-Use-Case-Wiki-A8-1f9d800083d68075bdf4d1150d70ebda?pvs=21)  
...
### Guides
- **NLP Framework Guide (A8):** [NLP Use Case Guide](https://www.notion.so/NLP-Use-Case-Guide-27fd800083d680f7a383c7d029e9f4c0?pvs=21)  
